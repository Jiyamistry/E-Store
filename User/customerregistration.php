                                                ...
                                                <div class="personal-info col-xl-6 col-lg-8 col-md-10">
                                                    ...
                                                    <div id="account-info">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="number" class="form-control" id="contact" placeholder="Contact" value="" name="contact" required="">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-6 col-sm-6">
                                                                <input type="text" class="form-control" id="country" placeholder="country" value="" name="country" required="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="password" name="password" id="password" class="form-control psw" required=""> 
                                                            </div>
                                                        </div>
