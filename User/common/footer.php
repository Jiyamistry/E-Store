                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                            <div class="single-widget">
                                ...
                                <div class="footer-widget-list ">
                                    <ul class="address">
                                        <li><span class="fa fa-map-marker"></span> Addresss: Ahmedabad</li>
                                        <li class="support-link"><span class="fa fa-envelope-o"></span> teamroyalmart@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-7 col-md-8">
                            <nav>
                                ...
                                <p class="author">Copyright © 2022 <a href="index.php">Royal Cloth Store</a> All Rights Reserved.</p>
                            </nav>
                        </div>
