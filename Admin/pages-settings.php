										...
										<div class="row">
											<div class="col-md-8">
												<div class="mb-3">
													...
													<input type="text" required="" class="form-control" id="name" name="name" value="<?php echo $raw->name;?>"></td>
												</div>
												<div class="mb-3">
													<label for="inputUsername" class="form-label">Biography</label>
													<textarea rows="2" required="" class="form-control" id="roll" name="roll" placeholder="Tell something about yourself"><?php echo $raw->roll ;?></textarea>
												</div>
												<div class="mb-3">
													<label for="inputUsername" class="form-label">Email</label>
													<input type="email" required=""class="form-control" id="email" name="email" placeholder="email" value="<?php echo $raw->email ;?>">
												</div>
												<div class="mb-3">
													<label for="inputUsername" class="form-label">Company</label>
													<input type="text" required="" class="form-control" id="work" name="work" placeholder="company" value="<?php echo $raw->work ;?>">
												</div>
												<div class="mb-3">
													<label for="inputUsername" class="form-label">Place</label>
													<input type="text" required="" class="form-control" id="place" name="place" placeholder="place" value="<?php echo $raw->place ;?>">
												</div>
											</div>
											<div class="col-md-4">
